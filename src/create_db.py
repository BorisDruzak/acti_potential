...
class DatabaseUpgrader:
    ...
    def _default_db_path() -> str:
        return os.path.join(app_config.get_data_path(), "main", "database.db")
...
def upgrade_database_for_approval_signing(db_path=None):
    ...
    try:
        ...
        upgrader = DatabaseUpgrader(db_path=db_path)
...
if __name__ == "__main__":
    # Запуск обновления
    upgrade_database_for_approval_signing()
